...
import com.gwk.weathers.util.Constants;
...
public class TrendView extends View {
	...
	public void setBitmap(List<Integer> topList, List<Integer> lowList){
		topBmps[0] = WeatherPic.getPic(c, topList.get(0), 0);
		topBmps[1] = WeatherPic.getPic(c, topList.get(1), 0);
		topBmps[2] = WeatherPic.getPic(c, topList.get(2), 0);
		topBmps[3] = WeatherPic.getPic(c, topList.get(3), 0);
		
		lowBmps[0] = WeatherPic.getPic(c, lowList.get(0), 0);
		lowBmps[1] = WeatherPic.getPic(c, lowList.get(1), 0);
		lowBmps[2] = WeatherPic.getPic(c, lowList.get(2), 0);
		lowBmps[3] = WeatherPic.getPic(c, lowList.get(3), 0);
	}
	@Override
